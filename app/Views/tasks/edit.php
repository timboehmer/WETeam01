                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <select name="taskartenid" class="form-select" required>
                            ...
                            <option value="1" <?= (isset($task['taskartenid']) && $task['taskartenid'] == 1) ? 'selected' : '' ?>>Aufgabe</option>
                            <option value="2" <?= (isset($task['taskartenid']) && $task['taskartenid'] == 2) ? 'selected' : '' ?>>Bug</option>
                            <option value="3" <?= (isset($task['taskartenid']) && $task['taskartenid'] == 3) ? 'selected' : '' ?>>Idee</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <select name="spaltenid" class="form-select" required>
                            <option value="1" <?= (isset($task['spaltenid']) && $task['spaltenid'] == 1) ? 'selected' : '' ?>>ToDo</option>
                            <option value="2" <?= (isset($task['spaltenid']) && $task['spaltenid'] == 2) ? 'selected' : '' ?>>In Bearbeitung</option>
                            <option value="3" <?= (isset($task['spaltenid']) && $task['spaltenid'] == 3) ? 'selected' : '' ?>>Erledigt</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <select name="erinnerung" class="form-select">
                            <option value="0" <?= (isset($task['erinnerung']) && $task['erinnerung'] == 0) ? 'selected' : '' ?>>Nein</option>
                            <option value="1" <?= (isset($task['erinnerung']) && $task['erinnerung'] == 1) ? 'selected' : '' ?>>Ja</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row mb-2">
